...
function run(){
 ...
 try{
  ...
  $('suggestions').innerHTML=values([['상·하부 주철근 공통 간격',`${o.commonSpacing} mm`],['하부 주철근',`${o.bottom.bar} @ ${o.commonSpacing} mm`],['상부 주철근',`${o.top.bar} @ ${o.commonSpacing} mm`],['배력근 · 상·하부 동일',`${o.p.tempBar} @ ${o.p.tempSpacing} mm`]])+'<p class="beam-muted">D10–D25, 주철근 간격 75–300 mm를 비교하여 조건을 만족하는 최소 철근량 조합을 자동 제안합니다. 배력근도 자동 설계합니다. 모멘트가 없는 면에도 조립을 위한 최소량을 배치하며, 상·하부 주철근 간격은 항상 같습니다. 전단·처짐 참고두께 부족은 철근 증가로 해결하지 않고 두께를 조정해야 합니다.</p>';
