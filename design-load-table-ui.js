...
function render(){
 ...
 try{
  ...
  $('basis').innerHTML='<p>고정하중 D = 각 마감재 하중의 합. 두께형 재료는 t(mm)/1,000 × γ(kN/m³), 면적형 재료는 q(kN/m²)를 직접 합산합니다. 중간값을 반올림하지 않고 합계 후 소수 둘째 자리까지 표시합니다.</p><p>사용하중은 D+L, 지배 계수하중은 max(1.4D, 1.2D+1.6L)입니다. <a href="https://www.kcsc.re.kr/standardCode/viewer/KDS%2041%2012%2000" target="_blank" rel="noopener">KDS 41 12 00</a> 1.7.1의 하중조합에서 D·L만 작용하는 경우입니다. 지붕활하중 Lr·설하중·강우하중·풍하중·지진하중 등은 포함하지 않습니다.</p><p>참고: 제공된 190207-RPT-KJH-설계하중Table-Rev01.xls의 「01-마감표」와 「02-설계하중표」. 초기 단위중량 및 활하중 3.00은 원본 예제값이며 용도별 법정 최솟값을 뜻하지 않습니다. KDS 41 12 00의 고정하중 산정 원칙에 따라 실제 마감 사양·제품 중량을 확인하고, 활하중은 해당 용도에 맞게 입력하세요. 원본의 물 단위중량 10.00 kN/m³도 수정할 수 있습니다.</p>';
